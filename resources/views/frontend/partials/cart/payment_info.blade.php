...
<div>
    ...
    <div class="row gutters-10">
        ...
        <div class="col-xl-4 col-md-6">
            <label class="aiz-megabox d-block mb-3">
                <input value="hubtel" class="online_payment" type="radio" name="payment_option">
                <span class="d-flex align-items-center justify-content-between aiz-megabox-elem rounded-0 p-3">
                    <span class="d-block fw-400 fs-14">{{ translate('Hubtel') }}</span>
                    <span class="rounded-1 h-40px overflow-hidden">
                        <img src="{{ static_asset('assets/img/cards/hubtel.png') }}" class="img-fit h-100">
                    </span>
                </span>
            </label>
        </div>
