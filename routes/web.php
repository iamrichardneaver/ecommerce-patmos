...
Route::get('/hubtel/payment/redirect', [HubtelController::class, 'redirectToGateway'])->name('hubtel.redirect');
Route::get('/hubtel/payment/callback', [HubtelController::class, 'handleGatewayCallback'])->name('hubtel.callback');
Route::get('/hubtel/payment/redirect', [HubtelController::class, 'redirectToGateway'])->name('hubtel.redirect');
Route::get('/hubtel/payment/callback', [HubtelController::class, 'handleGatewayCallback'])->name('hubtel.callback');
Route::get('/paystack/payment/callback', [PaystackController::class, 'handleGatewayCallback']);
Route::get('/hubtel/payment/callback', [HubtelController::class, 'payment_success']);
